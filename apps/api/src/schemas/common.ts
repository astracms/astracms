...
export const ErrorResponseSchema = z
  .object({
    ...
    message: z
      .string()
      .optional()
      .openapi({ example: "Additional error context" }),
  })
...
export const ForbiddenResponseSchema = z
  .object({
    ...
    message: z
      .string()
      .openapi({ example: "Insufficient permissions for this resource" }),
  })
...
export const RateLimitResponseSchema = z
  .object({
    error: z
      ...
      .openapi({ example: "Too Many Requests" }),
    message: z
      .string()
      .openapi({ example: "Rate limit exceeded. Please try again later." }),
    retryAfter: z
      .number()
      .optional()
      .openapi({ example: 60, description: "Seconds until rate limit resets" }),
  })
