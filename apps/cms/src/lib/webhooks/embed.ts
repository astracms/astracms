...
const ASTRACMS_COLOR = 5_786_879;
const ASTRACMS_AVATAR_URL = "https://astracms.com/logo.png";
...
export function getDiscordEmbed(args: {
  ...
  const embed = new EmbedBuilder()
    ...
    .setColor(ASTRACMS_COLOR)
    .setAuthor({
      name: "AstraCMS",
      iconURL: ASTRACMS_AVATAR_URL,
    })
    .setFooter({
      text: "Powered by astracms.com",
    });
  ...
  return {
    ...
    username: "AstraCMS",
    avatar_url: ASTRACMS_AVATAR_URL,
    embeds: [embed.toJSON()],
