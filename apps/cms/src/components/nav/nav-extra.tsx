"use client";
import { Button, buttonVariants } from "@astracms/ui/components/button";
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from "@astracms/ui/components/popover";
...
const resourceLinks = [
  ...
  },
  {
    ...
    href: "https://github.com/astracms/astracms/issues",
