  ...
  return (
    <div className="h-screen w-full md:grid md:grid-cols-2">
      <section className="relative hidden flex-col justify-between overflow-hidden p-10 md:flex">
        <Image
          alt="Light astracms texture background"
          className="object-cover object-center dark:hidden"
          fill
          loading="lazy"
          quality={100}
          src="/textures/astracms-light.avif"
          unoptimized
        />
        <Image
          alt="Dark astracms texture background"
          className="hidden object-cover object-center dark:block"
          fill
          loading="lazy"
          quality={100}
          src="/textures/astracms-dark.avif"
          unoptimized
        />
      ...
      <section className="flex h-full flex-col items-center justify-between p-4">
        ...
        <div>
          <p className="px-8 text-center text-muted-foreground text-xs">
            ...
            <Link
              className="underline underline-offset-4 hover:text-primary"
              href="https://astracms.com/privacy"
              target="_blank"
            >
              Privacy Policy
            </Link>
