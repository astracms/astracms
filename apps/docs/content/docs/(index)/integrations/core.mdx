...
<Cards cols={2}>
  <Card title="React" icon={<FileTextIcon />} href="/docs/integrations/react">
    Use React hooks for data fetching
  </Card>
  <Card title="Next.js" icon={<FolderIcon />} href="/docs/integrations/next">
    Server components with caching
  </Card>
  <Card title="Vue" icon={<VueIcon />} href="/docs/integrations/vue">
    Vue 3 composables
  </Card>
</Cards>
