...
1. [Fork](https://github.com/netronk/astracms/fork/) this repository to your own account
   ...
   ```bash
   git remote add upstream https://github.com/netronk/astracms.git
   ```
...
4. Database Setup
   ...
   Example:
   ```bash
   DATABASE_URL=postgresql://useastra:justuseastra@localhost:5432/astra
   ```
